    ...
    <div class="container-fluid">
      <div class="tab-content">
          ...
          <div class="row row-deck">
            @foreach($db_uoses as $db_uos)
              <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/administrator/uos/page?id={{$db_uos->uos_id}}">
                  <div class="card">
                    <div class="card-body">
              ...
              <tbody>
                @foreach($db_uoses as $db_uos)
                  <tr>
                    ...
                    <td>
                      <div><a href="/administrator/uos/page?id={{$db_uos->uos_id}}">{{$db_uos->uos_name}}</a></div>
                    ...
                    <td class="text-right">
                      <a class="btn btn-sm btn-link" href="/administrator/uos/delete?id={{$db_uos->uos_id}}" title="Delete"><i class="fa fa-trash text-danger"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
        ...
        <div class="tab-pane fade" id="addnew" role="tabpanel">
          <form action="/administrator/uos/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
            @csrf
            <div class="row clearfix">
              ...
              <div class="col-lg-4 col-md-12">
                <div class="form-group multiselect_div">
                  <select name="uos_semester" class="single-selection multiselect multiselect-custom" required autocomplete="off">
              ...
              <div class="col-lg-12 mt-3">
                <input type="submit" class="btn btn-primary" id="submitButton1" value="add">
              </div>
            </div>
          </form>
        </div>
