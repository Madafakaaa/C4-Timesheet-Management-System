          ...
          <div class="tab-pane fade show active" id="pills-tutor" role="tabpanel" aria-labelledby="pills-tutor-tab">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="tutor_add_new" role="tabpanel">
                <div class="card pb-0">
                  <div class="card-body">
                    <form action="/coordinator/uos/page/tutor/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
                      @csrf
                      <div class="row clearfix">
                        <div class="col-9">
          ...
          <div class="tab-pane fade" id="pills-tutorial" role="tabpanel" aria-labelledby="pills-tutorial-tab">
            ...
            <div class="tab-content">
                        ...
                        <div class="card-body pb-3">
                          ...
                          <div class="avatar-list mt-1">
                            ...
                            <div class="modal fade" id="addTutorModal_{{$tutorial['tutorial_id']}}" tabindex="-1" role="dialog" aria-hidden="true">
                              <form action="/coordinator/uos/page/tutorial/tutor/store" method="post">
                                @csrf
                    ...
                    <tbody>
                      @forelse($array_tutorials as $tutorial)
                        <tr>
                          ...
                          <td class="text-right">
                            <a class="btn btn-sm btn-link hidden-xs" href="/coordinator/uos/page/tutorial/delete?tutorial_id={{$tutorial['tutorial_id']}}"><i class="fa fa-trash text-danger"></i></a>
                          </td>
                        </tr>
                      @empty
                        <tr>
              ...
              <div class="tab-pane fade" id="tutorial_add_new" role="tabpanel">
                <div class="card pb-0">
                  <div class="card-body">
                    <form action="/coordinator/uos/page/tutorial/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
                      @csrf
                      <div class="row clearfix">
                        <div class="col-6">
                          <div class="form-group">
